...
มาตรฐานรูปแบบและการจัดสรร Sales Code สำหรับสินค้าปกติ, สินค้ามีหลาย
ตัวเลือก และ Rapid Entry/Live Sale ใช้ Authority กลางจาก
`AVENZO_ONE_Global_Sales_Code_Standard_V1.md`; ห้ามแต่ละหน้าสร้างกติกา Prefix,
เลขรัน หรือ rollover แยกกัน
...
| 19 ส.ค. 2026 | เพิ่มแนวทาง Reservation Reliability & Payment Recovery เป็น Future Plan: แยก On hand/Reserved/Committed/Available, ใช้ FIFO Waitlist/Pre-order, Payment Deadline, Auto-release, Reservation Control Center และ Risk Policy เพื่อลดสต็อกค้างและบิลไม่ชำระ โดยไม่แก้ระบบจริงก่อน Decision Gate |
| 19 ส.ค. 2026 | เพิ่ม C13 Customer Journey & Smart Tags เป็น Future Plan: server event ledger สำหรับ CF/Order/Payment/Review/Reservation โดยไม่ใช้ hidden pixel, มี source/rule/time decay, organization isolation และ privacy gate |
