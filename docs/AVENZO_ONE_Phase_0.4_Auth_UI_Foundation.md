...
- เพิ่มคำเตือนเมื่อเปิด Caps Lock ในช่องรหัสผ่าน
- แสดงรายการเงื่อนไขรหัสผ่านแบบตรวจทันทีระหว่างสมัคร: 8 ตัวอักษร, พิมพ์เล็ก, พิมพ์ใหญ่, ตัวเลข และสัญลักษณ์
- แปลข้อผิดพลาด Supabase Auth ที่พบบ่อยเป็นภาษาไทย และใช้ข้อความกลางเมื่อไม่รู้จักรหัสข้อผิดพลาด เพื่อไม่แสดงข้อความระบบดิบแก่ผู้ใช้
- เพิ่มลิงก์และหน้าร่าง “ประกาศความเป็นส่วนตัว” กับ “ข้อกำหนดการใช้งาน” โดยกำหนดให้ผ่าน Legal/PDPA Review ก่อน Production
