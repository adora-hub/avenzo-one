...
| Phase SS-01 Product Stock Status | **In Progress — Local UI/Read Model** | เพิ่มสถานะสต็อก 4 ระดับ `หมดสต็อก / ใกล้หมด / ปกติ / เข้าใหม่` แยกจากยอดสต็อก โดยอิง Balance, Reorder/Safety Stock และ Receive Movement 7 วัน; รายละเอียดอยู่ใน `AVENZO_ONE_Stock_Status_Development_Plan_V1.md` |
