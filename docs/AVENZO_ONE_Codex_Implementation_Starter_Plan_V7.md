...
| Phase 1.1.3.7.5.1 Controlled Live Checkout UI | Implemented / รอทดสอบ Local | เพิ่ม UI จำลองสำหรับเลือกผู้ทดสอบ กรอกยอดและรหัสอ้างอิง ตรวจ Production Readiness, Two-person Approval, Policy, Credentials และ Safety Lock พร้อมหน้าสรุป โดยไม่สร้าง Checkout Session, Payment Intent หรือรับเงินจริง |
