...
| Phase 1.1.3.8.1 Bank Transfer Channel Setup | Implemented / รอผู้ใช้ทดสอบ Local | Platform Admin ตั้งค่าบัญชีธนาคารหรือพร้อมเพย์ผ่าน UI, มี AAL2 + RLS + RPC + Audit + ตรวจสอบก่อนบันทึก และไม่เปลี่ยน Invoice/Payment/Subscription |
| Phase 1.1.3.8.2 Private Slip Upload | Planned / แผนถัดไป | ลูกค้าแนบหลักฐานลง Private Storage พร้อมข้อจำกัด MIME/ขนาดไฟล์และ RLS โดยยังไม่ยืนยันยอดอัตโนมัติ |
