...
| 16 ส.ค. 2569 | 2.1.R7.4.1 Product Field Contract Freeze | ล็อก Form → Atomic command → Database → Read Model → Grid/Quick View; Default Grid ต้องเพิ่มราคาขาย, Optional fields ใช้ Customize, Stock เป็น Inventory-derived, Cost permission-gated และ Branch/Multi-SKU ยัง Deferred | Completed / Owner approved; Sequential gate passed |
| 16 ส.ค. 2569 | 2.1.R7.4.2 Products Read Model Expansion | ขยาย List/Detail Read Model ให้รองรับ Category, Brand, Tags, ราคา/ภาษี, Physical/Packaging, Reorder, Creator, Sell Units และ Bundle; Cost query เฉพาะ `product.cost.read`; ใช้ bounded batch queries | Completed locally / Sequential gate passed |
| 16 ส.ค. 2569 | 2.1.R7.4.3 Default Data Grid Alignment | เพิ่มราคาขายจาก Read Model จริงและล็อก Default columns ตาม Approved Mockup; รองรับ single/range/mixed-currency/not-set โดยไม่แตะ cost; คง resize/F5 persistence | Completed locally / Sequential gate passed |
| 16 ส.ค. 2569 | 2.1.R7.4.4 Optional Columns & Customize | เพิ่ม Category, Brand, Tags, Barcode, Quantity, Tax, Reorder, Branches, Created metadata และ permission-gated Cost เป็น Optional columns; รองรับ show/hide, width, order, pin และ F5 persistence | Completed locally / Sequential gate passed |
| 16 ส.ค. 2569 | 2.1.R7.4.5 Product Quick View Alignment | จัด Quick View ตาม Approved Mockup และ Detail Read Model จริงครบ Overview, Images, SKU, Pricing/Tax, Inventory, Physical/Packaging, Sell Units, Bundle, Metadata และ Internal note; Cost permission-gated | Completed locally / Awaiting Owner Test; Stop gate |
| 16 ส.ค. 2569 | 2.1.R7.4.5A Status Control Correction | แยก Status select ออกจาก Quick View; ใช้ native compact select ขนาด/ระยะตาม Approved Mockup เลือก ใช้งานอยู่/ฉบับร่าง/เก็บถาวรตาม lifecycle guard เดิม และ Quick View เปิดจากเมนู `…` | Completed locally / Awaiting Owner Test; Stop gate |
| 16 ส.ค. 2569 | 2.1.R7.4.5B Pinned Columns Correction | แก้ sticky offset ของหัว/ข้อมูลให้เริ่มหลัง Checkbox 52px, ทำ Checkbox sticky, เรียง pinned columns ก่อน columns ทั่วไป, เพิ่ม Pin icon และ boundary shadow พร้อม F5 persistence | Completed locally / Awaiting Owner Test; Stop gate |
| 16 ส.ค. 2569 | 2.1.R7.4.5C Products Pagination | เพิ่ม Rows per page 10/25/50/100/300/400, exact range info และไอคอน first/prev/next/last; คง Filter/Page Size/Quick View state และใช้ tenant-scoped Server range | Completed locally / Awaiting Owner Test; targeted 4/4 + Product regression 211/211 + authenticated browser |
