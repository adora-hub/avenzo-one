...
export default async function DashboardPage() {
  ...
  const [{ data: organizations }, { data: subscriptions }, { data: canCreateOrganization }] = await Promise.all([
