...
export default async function BillingProductionReadinessPage() {
  ...
  return <main className="dashboard">
    ...
    <section className="content platform-subscription-content">
      <div className="hero"><div><div className="eyebrow">Phase 1.1.3.6</div><h1>ความพร้อมก่อนเปิดรับเงินจริง</h1><p>ตรวจระบบ หลักฐาน และผู้รับผิดชอบก่อนเสนอเปิด Stripe Live Mode</p></div><div className="button-row"><Link className="button secondary" href="/platform-admin/billing">กลับ Billing</Link><Link className="button secondary" href="/platform-admin">กลับ Platform Admin</Link></div></div>
