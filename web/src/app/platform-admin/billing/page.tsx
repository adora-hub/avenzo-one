...
export default async function PlatformAdminBillingPage({ searchParams }: { searchParams: Promise<BillingSearchParams> }) {
  ...
  return <main className="dashboard">
    ...
    <section className="content platform-subscription-content">
      <div className="hero"><div><div className="eyebrow">Phase 1.1.3.5.3</div><h1>Billing &amp; Payment Exceptions</h1><p>ตรวจรายการชำระเงินผิดปกติ ติดตาม SLA และเก็บหลักฐานทุกคำสั่งแก้ไข</p></div><div className="button-row"><Link className="button secondary" href="/platform-admin/billing/readiness">ตรวจความพร้อม Production</Link><Link className="button secondary" href="/platform-admin">กลับ Platform Admin</Link></div></div>
