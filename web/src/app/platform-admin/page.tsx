...
export default async function PlatformAdminPage() {
  ...
  return (
    <main className="dashboard">
      ...
      <section className="content"><div className="hero"><div><div className="eyebrow">Control Plane</div><h1>Organizations</h1><p>ตรวจสอบ Organization และจัดการ Subscription</p></div><div className="platform-admin-actions"><Link className="button secondary" href="/platform-admin/features">Feature Catalog</Link><Link className="button secondary" href="/platform-admin/plans">Plans &amp; Prices</Link><Link className="button secondary" href="/platform-admin/security/mfa">ตั้งค่า MFA</Link></div></div>
