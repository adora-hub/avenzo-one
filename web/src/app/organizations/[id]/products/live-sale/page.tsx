...
import { LiveSalePageShell } from './live-sale-page-shell'
...
export default async function LiveSalePage({ params }: Props) {
  ...
  return <ApplicationShell
    ...
    headerBreadcrumb={<ProductHeaderBreadcrumb organizationId={organizationId} currentPage="live-sale" />}
  >
    <section className="content product-workspace-page live-sale-page">
      <LiveSalePageShell
        organizationId={organizationId}
        organizationName={organization.name}
